    ...
    <div class="app-container">
        <el-card class="filter-container" shadow="never">
            <div>
                ...
                <span>日志匹配</span>
                <el-button style="float:right" type="primary" @click="handleMatch()" size="small">
                    开始匹配
                </el-button>
            ...
            <div style="margin-top: 15px">
                <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
                    <el-form-item label="数据对象">
                        <el-select v-model="taskData.dataObject" multiple filterable remote reserve-keyword
                            placeholder="请选择数据对象" :remote-method="remoteMethod" :loading="loading" size="medium">
        ...
        <el-dialog :visible.sync="logVisible" width="40%" title="日志上链">
            <div class="table-container">
...
import { createTask, getTaskList, getTaskById, intoChain } from '@/api/chain'
...
export default {
    ...
    created() {
        ...
        this.taskData.fileId = this.$route.query.fileId
        this.getList();
    },
    mounted() {
        getObjList().then(res => {
